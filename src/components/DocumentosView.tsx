...
import { STATUS_LABEL, type DocumentRecord, type DocumentStatus } from '@/lib/types';
...
export function DocumentosView({ documents, loading, onRegister }: DocumentosViewProps) {
  return (
          ...
          <tbody className="divide-y divide-hairline">
            ...
            {!loading &&
              documents.map((document) => (
                <tr key={document.id} className="align-top transition-colors hover:bg-canvas/50">
